...
label lunch_chaos:
    ...
    r "I, uh. Need a little help here?"
    n "Sabie swats at his hand. Rohan yelps."
    r "Hey, what was that for?"
    s "That. Would be cheating."
    s "Besties only help besties."
    s "Right, {i}ge{/i}?"
    n "Sabie winks at Masami."
    r "Hey! I thought we were besties."
    ...
    n "Sabie shrugs."
    s "It's not a big deal. You looked good. And they already knew all about your little schtick."
    r "…"
    s "Besides…weren't you the one who said you wanted everyone to get more comfy with {i}that{/i} side of yourself?"
    r "I - "
    r "…"
    n "Sabie grinned triumphantly."
    s "Don’t be shy. I know you, theater butterfly."
    n "Rohan's face turns deep red."
    r "I-I never said - "
    s "Sucks to suck ‘cuz you know I'm right."
    r "I - "
    r "Ugh. Fine."
    r "But that doesn't give you the right to send the rest of the - "
    s "Wait. You've got more pictures?"
    r "What? No, I didn't mean - "
    ...
    s "Oh, please. You know you're going to be thanking me later."
    s "And, {i}ge{/i}? If anything, you should be helping - me!"
    t "Or you could just watch them."
    r "What?"
    s "Hey!"
    n "Tyree shrugs."
    t "It's free entertainment."
    n "Sabie sticks her tongue out at him."
    s "Ugh. So rude."
    r "For once, I agree with her."
    s "Aw thanks, Rohan. I appreciate it."
    s "But also. Rude."
    m "(Hm…)"
...
label lunch_chaos_sabie:
    ...
    n "Rohan's expression instantly deflates. In the meantime, Sabie does a fist pump."
    ...
    r "Yeah. I get that. But…"
    n "His voice trails off as he looks away."
    m "If you're worried about rejection, we won't judge you for it."
    t "Agreed."
...
label lunch_chaos_tyree:
    ...
    r "What? You can't just - "
    s "Ohoho, you heard him. This one's between you and me, string bean."
    r "Urgh…"
    ...
    s "As you should. Those noodle arms got nothing on these guns."
    r "H-Hey! This time will be different."
    s "Sure. That's what you said last time."
    ...
    s "Ehe. Now, let's see…"
    s "Dammit. You changed the passcode again."
    n "Rohan's eyes glint back at her in triumph."
    r "Heh."
    s "Ugh. Maybe it’s the one from last week? Nope. Or the week before that? Nope again…"
    n "For the next minute, Sabie proceeds to a flurry of combinations. Eventually, she gives up and fixes Rohan with an overly sweet smile."
    s "Rohan, bestie, can you please - "
    r "Nope."
    s "But - "
    r "Sucks to suck."
    m "Well. Why am I not surprised?"
    n "Sabie glowers at him."
    s "Hey! What did I do to deserve that attitude from you?"
    t "Everything."
    s "Rude. I was not asking for your opinion."
    m "I mean, he does have a point. This is a weekly occurrence."
    r "Yeah. And now we're at the part where you give me my phone back?"
    n "Sabie purses her lips as her gaze bounces between Masami, Tyree, and Rohan."
    n "Then, she sighs and hands Rohan's phone back to him."
...
label lunch_stable:
    ...
    r "Why this question all of a sudden? Can we like, you know, talk about the usual stuff?"
    n "Sabie shrugs."
    s "We could. But I also kind of want to check in since {i}some{/i} people I don't share their feelings unless they're asked to."
    s "So. How about it?"
    r "Uh…"
    t "I'm doing fine."
    m "Same."
    r "What they said."
    s "That's…not quite what I meant."
    n "Tyree shrugs."
    t "I answered your question."
    m "He's not wrong."
    n "Sabie rolls her eyes dramatically."
    s "Oh, my bad. It seems that I did. Let me specify."
    ...
    r "Definitely thinking about it."
    s "Ayy, can't wait to see how it turns out!"
    s "Anyways, let's see, what else do I need to ask you emotionally constipated children to help you open up properly?"
    s "Oh yeah! Are you - "
    r "Um, I think we get the point."
    s "Great!"
...
label lunch_stable_tyree:
    ...
    m "…"
    r "Pft."
    s "That was kind of vague."
    t "I'm not sure what else you want me to say."
    s "Uh, anything on recruiting for swimming, robotics co-captaining for build season? Stuff like that?"
    t "Several schools seem interested in having me. Build season is going well."
    r "He means that MIT and Stanford have already talked about wanting to sign him on and that the robotics team is on track to go to Worlds again this year."
    ...
    n "Tyree blinks, looking genuinely confused."
    t "I thought it wasn't necessary to bring up."
    s "Well, that's exactly what I wanted you to bring up! Friends always celebrate each other's wins right?"
    t "Um. Sure."
    s "Now, that's the spirit!"
    n "Sabie then whirls on Rohan."
    s "And you, how did you know about this anyways when this kid over here won't open his mouth?"
    n "Rohan throws up his hands in surrender."
    r "Uh, my parents?"
    s "Oh, right. Sorry I asked."
...
label lunch_stable_rohan:
    ...
    s "I felt that."
    s "Anyways, how are you? Wanna tell us about your life?"
    r "Dammit. I was hoping you'd forget."
    s "Not a chance. So, what do you have to say for yourself?"
    r "Uh, my grades are probably good enough for me to go to the state university for medical school and my classes are kinda interesting?"
    ...
    r "I still haven't done anything for Science Olympiad, though. Or HOSA. Or the Intel Research competition. I need to get on that."
    r "Anyways, I am definitely very tired and looking forward to break."
...
label lunch_stable_masami:
    ...
    s "It's your turn for a group progress update."
    m "Oh."
    ...
    r "Yeah, unfortunately. Are we coming here again tomorrow?"
    s "Yep!"
    n "Sabie grins at Rohan."
    s "Next time, I {i}will{/i} get my hands on those pictures. Just you wait."
    r "Sure, as long as you remember."
    t "You won't."
    r "Oop."
    s "Hey!"
    m "He's not wrong."
    m "Anyways, I've really got to run. See you all!"
    r "See you!"
    t "Bye."
...
label lunch_end:
    ...
    m "Hm?"
    n "Masami glances over his shoulder as if he's just noticed Sabie tearing down the sidewalk at full speed."
    n "He dramatically slows to a stop to let her catch up to him."
    ...
    s "There's still a lot of things going on in there that you aren't telling me."
    s "Not even after these sixteen {i}long{/i} years of knowing each other."
    m "Seventeen."
    s "Sixteen. I'm younger than you, remember?"
    m "I know."
    m "But your birthday's two months and a day from now, and our moms have been hanging out together long before they had us."
    m "So I'm sticking with seventeen."
    s "Pft. Okay, {i}ge{/i}. Whatever you say."
    m "...You aren’t ever going to stop calling me {i}ge{/i}, are you?"
    s "Of course, not. Why ask, though? Still hung up over the fact that it’s \"culturally incorrect?\""
    m "I’m not complaining. Just thinking about how it’s sort of become \"our thing.\" Kind of like…"
    m "Never mind."

    # The more serious part of the conversation
    s "Is everything alright? You've been kind of stuck in that head of yours for days now."
...
label lunch_end_honest:
    ...
    m "Yeah. Kinda."
    s "It's about Xinyi, right?"
    m "…"
    m "Yeah."
    s "Don't worry so much. She'll be back, I'm sure of it."
...
label lunch_end_vague:
    ...
    s "You need someone to talk to."
    m "And that person {i}has{/i} to be you. Right."
    s "Oh, come on! Who else is qualified enough?"
    m "Well - "
    s "Don't get me wrong, your guy friends are great and all. But do you really think that you're going to bring up any of your {i}feelings{/i} with any of them?"
    m "That's - "
    s "And!"
...
label lunch_end_deny:
    ...
    s "…If you say so."
    s "Just tell me if you need anything, alright?"
    m "Uh…"
    m "Sure."
...
label lunch_end_invite:
    ...
    s "Well, Tyree was going anyways, but you get the point."
    n "Masami sighs."
    ...
    s "And if someone doesn't give you a good one, you're never going to learn about how nice it is to just live in the moment instead of brooding all the time."
    m "I do not brood."
    s "You do brood. You're doing it right now."
    m "This isn't brooding. This is exasperation."
    n "Sabie waves her hand dismissively."
    s "Same difference."
    s "Anyways. It doesn't hurt to start the weekend a little early, now does it?"
    m "We'll still have class the next day."
    s "Psh. Teachers know that break starts next week."
    s "They can't give us {i}that{/i} much more grief when finals are in January, can they?"
    m "That's not how - "
    s "Come on. It's just one day."
    s "One singular day."
    s "You can relax, chat up some girls - "
    m "I can't chat up girls - "
    s "Please, I've seen you in your glory days."
    ...
    s "Psh, whatever. What I {i}mean{/i} is that you have experience."
...
label lunch_end_alyssa:
    ...
    n "As soon as they're safely behind the wall, Sabie bats his hand away and glowers at him."
    s "What the hell was that for? I'm doing you - "
    m "Please. Just."
    n "Masami sighs."
    m "Why is it that you two have to be friends?"
    s "Are you questioning my bestie status with Alyssa?"
    m "No! Of course not - "
    m "Ugh, that's not what I meant, but whatever."
    m "I've already told you that I've stopped trying to \"get to know her better.\""
    s "Uh, you did not tell me that you've stopped trying. You told me it was complicated."
...
label lunch_end_ignore:
    ...
    s "Pst. Pay attention."
    m "No."
    s "But aren't you the least bit curious?"
    m "No."
    s "Don't you want to talk to Alyssa the slightest bit?"
    m "…"
    m "No."
    s "Aha, I see that hesitation! I know you. I know you want to hear her voice…"
    m "Will you shut up?"
    s "Who do you think I am?"
    m "Please?"
    s "Not until you put your eyes in the right place."
    m "Ugh, fine."
    m "I'll pay attention."
    m "But only because I know you won't stop otherwise."
    n "Sabie grins and rubs her hands together."
...
label lunch_end_nasir:
    ...
    na "Not really."
    a "Yes, you are."
    n "Alyssa gives him a playful bump on the shoulder."
    ...
    s "You still beat me every time by at least 200 points."
    m "I hate to say it, but you're just not very good."
    m "(That and Words with Friends doesn't have a time limit.)"
    ...
    n "Nasir looks briefly at Sabie."
    n "Then, his gaze settles on Masami."
    m "Uh. Hi?"
    n "Nasir just blinks at him, his expression blank."
    n "Masami swallows."
    ...
    m "(???)"
    a "Uh, Nasir?"
    n "Nasir's eyes widen and he blinks, startled."
    na "Huh?"
    a "You still there?"
    ...
    na "You’ll find them. If you know where to look."
    a "Ah. Well, I’ll take your word for it."
    na "...Alright."
    a "What?"
    na "It’s nothing."
    a "Okay then…"
    na "Anyways, what was I saying before?"
...
label lunch_end_party:
    ...
    m "Tyree is Tyree."
    s "Eh, you’re not wrong. No Smash then."
    n "Sabie thinks for a moment."
    s "Okay. I've got it."
    m "What?"
    s "I'll just introduce you to some of my friends who also sit in the corner."
    s "And then you guys can sit in awkward silence together!"
    m "…"
    s "Or play Scrabble or whatever else you nerds do."
    m "Aren't you also a nerd too?"
    s "Psh, you know what I mean. Anyways, it'll be fun!"
    s "Whaddya say?"
    m "…"
    ...
    # SEFF: Warning Bell
    s "Shit!"
    s "Gotta run. Text me later when your answer is yes!"
    m "Wait, Sabie - "
    m "(And she's gone.)"
    m "…"
