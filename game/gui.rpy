...
define gui.accent_color = u'#29a8d2'

## The color used for a text button when it is neither selected nor hovered.
define gui.idle_color = u'#7B9DBA'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = u'#5F819E'
...
define gui.selected_color = u'#073D6D'

## The color used for a text button when it cannot be selected.
define gui.insensitive_color = u'#417C8A'
...
define gui.name_text_font = "SourceSerifPro-Regular.ttf"

## The font used for out-of-game text.
define gui.interface_text_font = "SourceSerifPro-Regular.ttf"
